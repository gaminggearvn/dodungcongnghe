                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 flex items-center justify-center bg-slate-100 rounded-xl group-hover:bg-slate-900 transition-colors p-1 shrink-0 overflow-hidden">
                      <img src="https://cdn.pixabay.com/photo/2022/08/23/17/29/tiktok-7406196_1280.png" alt="TikTok Logo" className="w-full h-full object-contain group-hover:scale-110 transition-transform" />
                    </div>
